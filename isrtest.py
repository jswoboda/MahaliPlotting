...
if __name__== '__main__':
    ...
    xvec = np.linspace(-150.,150.,256)
    yvec = np.linspace(-50.,150.,256)
    Xmat,Ymat=np.meshgrid(xvec,yvec)
    xycoords = np.column_stack((Xmat.flatten(),Ymat.flatten()))
    newcordname='Cartesian'
    vbounds=[[1e10,5e11],[1500.,3000.],[1500.,3000.]]
    times = ['2015-10-11 10:00:00','2015-10-11 12:00:00']
    pnheights=[('Ne',150.),('Ti',250.),('Te',250.)]
    getSRIhdf5(filename,times,pnheights,xycoords,newcordname,vbounds)